...
app.post("/api/v1/patches/check", (req, res) => {
  ...
  res.send({
    ...
    patch: 
      {
        number: 1,
        hash: "12bd4b4a78638beb1dc3928a540cfce7c72e558ff287282200368383b5bc65ec",
...
app.get("/api/v1/apps/457789c6-f756-4650-a3e1-06da8d2032fc/releases/1/patches", (req, res) => {
  console.log("== release patches request", req);
  res.send({ artifacts: [
    {
       id: "1",
